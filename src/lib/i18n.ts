...
const en: Messages = {
  ...
  "cart.addThisToo": "Add",
  "cart.addThisTooTitle": "Add this too",
  "cart.freeDeliveryGap": "Add {amount} more for free delivery in Ghana",
  "product.pairsWell": "Pairs Well With",
  "product.peopleAlsoLike": "People also like",
  "product.from": "From {price}",
  "product.views": "{n} views",
  "product.likes": "{n} likes",
  ...
  "footer.csr": "Corporate Social Responsibility",
...
const fr: Messages = {
  ...
  "cart.addThisToo": "Ajouter",
  "cart.addThisTooTitle": "Ajoutez aussi",
  "cart.freeDeliveryGap": "Ajoutez {amount} pour la livraison gratuite au Ghana",
  "product.pairsWell": "S'accorde avec",
  "product.peopleAlsoLike": "Vous aimerez aussi",
  "product.from": "À partir de {price}",
  "product.views": "{n} vues",
  "product.likes": "{n} j'aime",
  ...
  "footer.csr": "Responsabilité sociétale",
...
const es: Messages = {
  ...
  "cart.addThisToo": "Añadir",
  "cart.addThisTooTitle": "Añade también",
  "cart.freeDeliveryGap": "Añade {amount} más para envío gratis en Ghana",
  "product.pairsWell": "Combina con",
  "product.peopleAlsoLike": "También te puede gustar",
  "product.from": "Desde {price}",
  "product.views": "{n} visitas",
  "product.likes": "{n} me gusta",
  ...
  "footer.csr": "Responsabilidad social corporativa",
...
const pt: Messages = {
  ...
  "cart.addThisToo": "Adicionar",
  "cart.addThisTooTitle": "Adicione também",
  "cart.freeDeliveryGap": "Adicione {amount} para entrega grátis em Gana",
  "product.pairsWell": "Combina com",
  "product.peopleAlsoLike": "Também pode gostar",
  "product.from": "A partir de {price}",
  "product.views": "{n} visualizações",
  "product.likes": "{n} curtidas",
  ...
  "footer.csr": "Responsabilidade social corporativa",
...
const de: Messages = {
  ...
  "cart.addThisToo": "Hinzufügen",
  "cart.addThisTooTitle": "Das passt auch",
  "cart.freeDeliveryGap": "Noch {amount} für kostenlose Lieferung in Ghana",
  "product.pairsWell": "Passt gut zu",
  "product.peopleAlsoLike": "Das könnte Ihnen auch gefallen",
  "product.from": "Ab {price}",
  "product.views": "{n} Aufrufe",
  "product.likes": "{n} Likes",
  ...
  "footer.csr": "Unternehmerische Sozialverantwortung",
